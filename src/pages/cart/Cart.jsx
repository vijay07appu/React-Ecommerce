...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_ISxyp5oUpLRA1R",
      key_secret: "Hjy9ZC8VZyf3qs3wM81OlrxT ",
  ...
  return (
    <Layout >
      <div className="h-screen bg-gray-100 pt-5 mb-[10%]" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
